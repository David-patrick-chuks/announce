              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-gray-700 text-sm leading-relaxed">
                    <span className="font-semibold text-gray-800">Important Note:</span> This platform is an independent service and is not affiliated with the Government of Nigeria. We aggregate publicly available information for educational and informational purposes only.
                  </p>
                </div>
              </div>
            </div>
